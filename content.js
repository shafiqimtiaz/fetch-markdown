/**
 * Fetch Markdown v4.0 — Content Script
 *
...
(function () {
  ...
  function log(...args) {
    if (DEBUG) console.log('[Fetch Markdown v' + VERSION + ']', ...args);
  }

  // Mark script as loaded.
  console.log('[Fetch Markdown v' + VERSION + '] Content script loaded. Site type:',
    detectSiteType().type);
})();
